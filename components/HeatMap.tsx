...
const extractMonthAndDay = (
	...
	const month = Number.parseInt(parts[1], 10) - 1 // Convert from 1-based to 0-based

	return { month, day }
}

// Extract creation date info
const extractCreationInfo = (
		...
		<ThemedView style={styles.container} useGradient={true}>
			...
			>
				{MONTH_NAMES.map((monthName, index) => {
					...
					return (
						<View style={styles.monthWrapper} key={monthName}>
							<ThemedText
								style={[styles.monthName, { color: secondaryTextColor }]}
							>
								{monthName}
							</ThemedText>
